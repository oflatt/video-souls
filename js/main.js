...
(function (GameMode) {
    ...
    GameMode[GameMode["RECORDING"] = 2] = "RECORDING";
})(GameMode || (GameMode = {}));
var InputDirection;
(function (InputDirection) {
    InputDirection[InputDirection["LEFT"] = 1] = "LEFT";
    InputDirection[InputDirection["UP"] = 2] = "UP";
    InputDirection[InputDirection["RIGHT"] = 4] = "RIGHT";
    InputDirection[InputDirection["DOWN"] = 8] = "DOWN";
})(InputDirection || (InputDirection = {}));
var AttackDirection;
(function (AttackDirection) {
    AttackDirection[AttackDirection["UP"] = 0] = "UP";
    AttackDirection[AttackDirection["UP_RIGHT"] = 1] = "UP_RIGHT";
    AttackDirection[AttackDirection["RIGHT"] = 2] = "RIGHT";
    AttackDirection[AttackDirection["DOWN_RIGHT"] = 3] = "DOWN_RIGHT";
    AttackDirection[AttackDirection["DOWN"] = 4] = "DOWN";
    AttackDirection[AttackDirection["DOWN_LEFT"] = 5] = "DOWN_LEFT";
    AttackDirection[AttackDirection["LEFT"] = 6] = "LEFT";
    AttackDirection[AttackDirection["UP_LEFT"] = 7] = "UP_LEFT";
    AttackDirection[AttackDirection["CENTER"] = 8] = "CENTER";
})(AttackDirection || (AttackDirection = {}));
var AttackAnimation;
(function (AttackAnimation) {
    AttackAnimation[AttackAnimation["NONE"] = 0] = "NONE";
    AttackAnimation[AttackAnimation["PARRYING"] = 1] = "PARRYING";
    AttackAnimation[AttackAnimation["ATTACKING"] = 2] = "ATTACKING";
    AttackAnimation[AttackAnimation["STAGGERING"] = 3] = "STAGGERING";
...
class VideoSouls {
    constructor(player) {
        this.elements = {
            ...
            currentTimeDebug: document.querySelector("#current-time"),
            videoUrlInput: document.querySelector("#video-url"),
            recordSpeedInput: document.querySelector("#record-speed"),
    ...
    getAttacksInInterval(startTime, endTime) {
    ...
    drawCenteredRotated(image, xpos, ypos, angle, alpha) {
        const ctx = this.elements.canvas.getContext('2d');
        ctx.save();
...
// Directions
function netDirection(directionsArr) {
...
const directionNumToDir = new Map([
    [0, [-1, 0]],
    [1, [-1, 1]],
    [2, [0, 1]],
    [3, [-1, -1]],
...
const blockDirectionPositions = new Map([
    [0, [0.0, 0.2]],
    [1, [0.2, 0.2]],
    [2, [0.2, 0.0]],
    [3, [0.2, -0.2]],
